...
There are important details about when and whether this estimate of generalization error is good --- if you use cross-validation for model comparison (described below in a bit), then you probably want to split your data into three sets: training set / validation set / test set. If you select your model based on the test set, then you will generally underestimate your generalization error. You will underestimate it *by more* the more models you compare. I'll ignore these (important) details for the rest of the post and refer you to Chapter 7 in [*Elements of Statistical Learning*](https://web.stanford.edu/~hastie/Papers/ESLII.pdf) for more discussion.
