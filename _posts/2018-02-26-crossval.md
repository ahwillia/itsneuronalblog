...
post_description: "Cross-validation is a somewhat tricky problem for PCA, clustering, and other matrix factorization models. This post provides some Python code snippets for fitting these models with held out data."
---
