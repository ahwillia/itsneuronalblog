...
{% include image.html url="/itsneuronalblog/img/clustering/kmeans_fail.png" width="500px" title="A dataset where single-linkage outperforms k-means." description="If your data contains long paths, then single-linkage clustering (panels B and D) will typically perform better than k-means (panels A and C)."%}
