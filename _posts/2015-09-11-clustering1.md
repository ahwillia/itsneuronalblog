...
{% include image.html url="/itsneuronalblog/img/clustering/kmeans_fail.png" width="500px" title="A dataset where single-linkage outperforms k-means." description="If your dataset contains long paths, then single-linkage clustering (panels B and D) will typically perform better than k-means (panels A and C)."%}
...
**[4]** See [Tibshirani et al. (2001)](http://dx.doi.org/10.1111/1467-9868.00293), [Dudoit & Fridlyand (2002)](http://dx.doi.org/10.1186/gb-2002-3-7-research0036), [Figueiredo & Jain (2002)](http://dx.doi.org/10.1109/34.990138), [Yan & Ye (2007)](http://dx.doi.org/10.1111/j.1541-0420.2007.00784.x)<br>
