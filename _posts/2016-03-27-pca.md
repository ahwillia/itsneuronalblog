...
#### PCA fails to recover the true linear subspace of maximal variance if $p > n$ (it is an [inconsistent](https://en.wikipedia.org/wiki/Consistent_estimator) estimator).
