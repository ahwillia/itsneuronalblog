...
* Our goal is to find the *best* or *optimal* clustering (i.e. the one with the lowest value of $F$). We call the optimal clustering $\mathcal C_{opt}$ , and the lowest/best value of the objective function $F_{opt}$.
